										...
										<form action="#" className="form-contact">
											<div className="box grid-2">
												<fieldset>
													...
													<input type="text" className="form-control style-1" placeholder="Name" />
												</fieldset>
												<fieldset>
													<label htmlFor="email">Email Address:</label>
													<input type="text" className="form-control style-1" placeholder="Email" />
												</fieldset>
											</div>
											<div className="box grid-2">
												<fieldset>
													<label htmlFor="phone">Phone Numbers:</label>
													<input type="text" className="form-control style-1" placeholder="ex 012345678" />
												</fieldset>
												<fieldset>
													<label htmlFor="subject">Subject:</label>
													<input type="text" className="form-control style-1" placeholder="Enter Keyword" />
												</fieldset>
											</div>
											<fieldset className="box">
												<label htmlFor="message">Your Message:</label>
												<textarea name="message" className="form-control" cols={30} rows={10} placeholder="Message" defaultValue={""} />
											</fieldset>
